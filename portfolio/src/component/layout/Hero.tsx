...
function Hero() {
    ...
    <div className="flex mobile:justify-center desktop:flex-row desktop:items-center mobile:flex-col-reverse items-center w-full flex-1">
            <div className="flex flex-col z-20 pointer-events-none text-white desktop:w-3/5 mobile:w-full mobile:text-center">
                <p className="desktop:text-[5vw] mobile:text-[8vw] font-bold text-lightcyan w-full">Greetings, I&apos;m Krishna Kashiv,</p>
                <p className="desktop:text-[3vw] mobile:text-[5vw]">a software engineer with expertise in data engineering, analytics, machine learning, and generative AI with</p>
            ...
            <img className="w-2/5 mobile:w-full mobile:max-w-xl object-contain self-center animate-scalepulse" src="/portraitdummy.png" alt="Portrait" />
        </div>
